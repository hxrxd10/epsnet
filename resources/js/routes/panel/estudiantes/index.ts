...
/**
* @see \App\Http\Controllers\Panel\OrdenImpresionController::ordenImpresion
...
ordenImpresion.url = (args: { expediente: string | number | { id: string | number } } | [expediente: string | number | { id: string | number } ] | string | number | { id: string | number }, options?: RouteQueryOptions) => {
    ...
    return ordenImpresion.definition.url
            .replace('{expediente}', parsedArgs.expediente.toString())
            .replace(/\/+$/, '') + queryParams(options)
}
...
ordenImpresion.form = ordenImpresionForm

const estudiantes = {
    index: Object.assign(index, index),
    show: Object.assign(show, show),
    ordenImpresion: Object.assign(ordenImpresion, ordenImpresion),
    verificacion: Object.assign(verificacion, verificacion),
}
