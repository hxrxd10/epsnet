...
/**
* @see \App\Http\Controllers\Estudiante\SeguimientoImpactoController::index
* @see app/Http/Controllers/Estudiante/SeguimientoImpactoController.php:20
* @route '/estudiante/expedientes/{expediente}/seguimiento'
*/
...
index.definition = {
    methods: ["get","head"],
    url: '/estudiante/expedientes/{expediente}/seguimiento',
...
/**
* @see \App\Http\Controllers\Estudiante\SeguimientoImpactoController::store
* @see app/Http/Controllers/Estudiante/SeguimientoImpactoController.php:45
* @route '/estudiante/expedientes/{expediente}/seguimiento'
*/
...
/**
* @see \App\Http\Controllers\Estudiante\SeguimientoImpactoController::update
* @see app/Http/Controllers/Estudiante/SeguimientoImpactoController.php:52
* @route '/estudiante/expedientes/{expediente}/seguimiento/{registro}'
*/
...
update.definition = {
    methods: ["put","patch"],
    url: '/estudiante/expedientes/{expediente}/seguimiento/{registro}',
...
/**
* @see \App\Http\Controllers\Estudiante\SeguimientoImpactoController::destroy
* @see app/Http/Controllers/Estudiante/SeguimientoImpactoController.php:59
* @route '/estudiante/expedientes/{expediente}/seguimiento/{registro}'
*/
...
const SeguimientoImpactoController = { index, store, update, destroy }

export default SeguimientoImpactoController