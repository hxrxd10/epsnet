...
/**
* @see \App\Http\Controllers\Estudiante\ProgramaExpedienteController::update
...
update.definition = {
    methods: ["put"],
    url: '/estudiante/expedientes/{expediente}/programa',
...
const ProgramaExpedienteController = { update }

export default ProgramaExpedienteController