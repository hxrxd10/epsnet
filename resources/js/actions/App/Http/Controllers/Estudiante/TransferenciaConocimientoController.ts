...
/**
* @see \App\Http\Controllers\Estudiante\TransferenciaConocimientoController::index
* @see app/Http/Controllers/Estudiante/TransferenciaConocimientoController.php:21
* @route '/estudiante/expedientes/{expediente}/transferencias'
*/
...
index.definition = {
    methods: ["get","head"],
    url: '/estudiante/expedientes/{expediente}/transferencias',
...
/**
* @see \App\Http\Controllers\Estudiante\TransferenciaConocimientoController::store
* @see app/Http/Controllers/Estudiante/TransferenciaConocimientoController.php:43
* @route '/estudiante/expedientes/{expediente}/transferencias'
*/
...
/**
* @see \App\Http\Controllers\Estudiante\TransferenciaConocimientoController::update
* @see app/Http/Controllers/Estudiante/TransferenciaConocimientoController.php:50
* @route '/estudiante/expedientes/{expediente}/transferencias/{registro}'
*/
...
update.definition = {
    methods: ["put","patch"],
    url: '/estudiante/expedientes/{expediente}/transferencias/{registro}',
...
/**
* @see \App\Http\Controllers\Estudiante\TransferenciaConocimientoController::destroy
* @see app/Http/Controllers/Estudiante/TransferenciaConocimientoController.php:57
* @route '/estudiante/expedientes/{expediente}/transferencias/{registro}'
*/
...
const TransferenciaConocimientoController = { index, store, update, destroy }

export default TransferenciaConocimientoController